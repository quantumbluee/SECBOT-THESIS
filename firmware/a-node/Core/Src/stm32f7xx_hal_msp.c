...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PA5     ------> SPI1_SCK
    */
    HAL_GPIO_DeInit(GPIOB, ARD_D11_TIM3_CH2_SPI1_MOSI_Pin|ARD_D12_SPI1_MISO_Pin);

    HAL_GPIO_DeInit(ARD_D13_SPI1_SCK_GPIO_Port, ARD_D13_SPI1_SCK_Pin);
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PC3     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOI, PMOD_SPI2_SCK_Pin|PMOD_SPI2_NSS_Pin);

    HAL_GPIO_DeInit(GPIOC, STMOD_SPI2_MISOs_Pin|STMOD__SPI2_MOSIs_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM2)
  {
    ...
    PA1     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = STMOD__TIM2_CH1_2_ETR_Pin|ARD_D10_TIM2_CH2_SPI1_NSS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
